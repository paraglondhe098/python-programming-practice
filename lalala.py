#Fileopen
#File names Harrydiet.txt,Hammaddied.txt,Rohandiet.txt,Harryexe.txt,Rohanexe.txt,Hammadexe.txt
...
while(True):
    ...
    try:
        ...
        print("Invalid input! try again")
        continue
    print("What do you want to view/log ?")
    print(" 1) 1 For View/log Diet"
          "\n 2) 2 For View/log Exercise")
    try:
        z = int(input("=>"))
    except ValueError:
        print(4 * "*")
